...
router.post('/', async (req, res) => {
  ...
  try {
    const { rows } = await pool.query(
      ...
      [name.trim(), contact_name || null, email || null, phone || null, address || null, notes || null]
    );
...
router.put('/:id', async (req, res) => {
  ...
  try {
    const { rows } = await pool.query(
      ...
      [name.trim(), contact_name || null, email || null, phone || null, address || null, notes || null, req.params.id]
    );
